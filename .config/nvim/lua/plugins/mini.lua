return {
    ...
    -- File explorer (this works properly with oil unlike nvim-tree)
    {
        ...
        config = function()
            ...
            vim.keymap.set('n', '<leader>ee', '<cmd>lua MiniFiles.open()<CR>', { desc = 'Toggle mini file explorer' })  -- toggle files explorer
    ...
    },
    {
        ...
        opts = {
            ...
            -- - Place surroundings on seperate lines in linewise mode.
